    ...
    <div className="bg-black text-white overflow-hidden">
      ...
      <section id="home" className="relative min-h-screen flex items-center justify-center overflow-hidden pt-20">
        ...
        <div className="relative z-10 text-center px-4 sm:px-6 lg:px-8 max-w-4xl mx-auto">
          ...
          <h1 className="text-5xl sm:text-6xl font-light tracking-tight mb-6 leading-tight">
            Victoria Event Group
            <span className="block text-amber-400 mt-4 text-4xl sm:text-5xl">Nuestros espacios exclusivos a 15 min de Madrid</span>
          </h1>
          ...
          <div className="flex flex-col sm:flex-row gap-6 justify-center">
            <button onClick={() => scrollToSection('organizaevento')} 
              className="px-10 py-4 bg-blue-500 text-white font-light text-lg hover:bg-blue-600 transition-all duration-300 hover:shadow-2xl hover:shadow-blue-500/50 hover:scale-105 cursor-pointer">
              Organizar mi evento privado
            </button>
            <button onClick={() => scrollToSection('proximasfiestas')} 
              className="px-10 py-4 bg-green-500 text-white font-light text-lg hover:bg-green-600 transition-all duration-300 hover:shadow-2xl hover:shadow-green-500/50 hover:scale-105 cursor-pointer">
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              ...
              <div key={idx} className="group relative overflow-hidden border border-gray-700 hover:border-amber-400 transition-all duration-300 hover:bg-gray-800/50">
                <div className="aspect-video bg-gradient-to-br from-amber-400/20 to-black/50 group-hover:from-amber-400/40 transition-all duration-500 flex items-center justify-center">
                ...
                <div className="p-6">
                  <h3 className="text-2xl font-light text-amber-400 mb-4">{event.title}</h3>
                  
                  <div className="flex items-center gap-2 text-gray-300 font-light mb-2">
                    <Calendar size={16} />
                    <span>{event.date}</span>
                  </div>

                  <div className="flex items-center gap-2 text-gray-300 font-light mb-6">
                    <DollarSign size={16} />
                    <span>{event.price}</span>
                  </div>

                  <a href={event.link} target="_blank" rel="noopener noreferrer"
                    className="inline-block px-6 py-2 bg-amber-400 text-black font-light hover:bg-amber-300 transition-all duration-300">
                    Comprar entradas
                  </a>
                </div>
              </div>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              ...
              <div key={idx} className="group relative p-8 border border-gray-700 hover:border-amber-400 transition-all duration-300 hover:shadow-2xl hover:shadow-amber-400/20 hover:bg-gray-800/50 cursor-pointer">
      ...
      <section id="contacto" className="relative py-24 px-4 sm:px-6 lg:px-8 bg-gradient-to-b from-black to-gray-900">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="flex justify-center mb-16">
            <a href="https://wa.me/34673523133" target="_blank" rel="noopener noreferrer"
              className="flex items-center gap-4 px-12 py-6 bg-green-500 text-white font-light text-lg hover:bg-green-600 transition-all duration-300 hover:shadow-2xl hover:shadow-green-500/50 hover:scale-105">
              <MessageCircle size={32} />
              <span>+34 673 523 133</span>
            </a>
          </div>
              ...
              <div className="space-y-8">
                <div className="flex items-start space-x-6">
                  ...
                  <div>
                    ...
                    <a href="tel:+34900000000" className="text-white hover:text-amber-400 transition-colors text-lg">
                      +34 900 000 000
                    </a>
                  </div>
                </div>
            ...
            <form onSubmit={handleFormSubmit} className="space-y-6">
              <div>
                <input type="text" name="nombre" placeholder="Tu Nombre" 
                  ...
                  className="w-full bg-gray-800 border border-gray-700 focus:border-amber-400 px-6 py-3 text-white placeholder-gray-500 outline-none transition-colors font-light" />
              </div>
              ...
              <div>
                <input type="date" name="fecha" 
                  ...
                  className="w-full bg-gray-800 border border-gray-700 focus:border-amber-400 px-6 py-3 text-white outline-none transition-colors font-light" />
              </div>

              <div>
                <textarea name="mensaje" placeholder="Cuéntanos sobre tu evento" rows="5"
                  value={formData.mensaje} onChange={handleFormChange}
                  className="w-full bg-gray-800 border border-gray-700 focus:border-amber-400 px-6 py-3 text-white placeholder-gray-500 outline-none transition-colors font-light resize-none"></textarea>
              </div>

              <button type="submit" className="w-full px-6 py-3 bg-amber-400 text-black font-light hover:bg-amber-300 transition-all duration-300 hover:shadow-lg hover:shadow-amber-400/50 cursor-pointer">
                Enviar
              </button>
            </form>
          </div>
